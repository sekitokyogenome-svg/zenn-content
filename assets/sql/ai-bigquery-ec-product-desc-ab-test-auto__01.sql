-- 出典: AI×BigQueryでEC商品説明文のA/Bテスト結果を自動分析・改善提案する仕組み
-- 記事: articles/ai-bigquery-ec-product-desc-ab-test-auto.md（BigQueryでA/Bテスト結果を集計するSQL）
-- ${PROJECT} / ${DATASET} は実行前に実値へ置換すること

-- GA4 BigQuery エクスポートテーブルを使ったA/Bテスト集計
-- テーブル名: `${PROJECT}.${DATASET}.events_*`
-- 対象期間: 直近30日
