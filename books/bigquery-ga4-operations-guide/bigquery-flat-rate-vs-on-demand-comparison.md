---
title: "【第2部 コストを制御する】BigQueryのフラットレート vs オンデマンド料金を実データで比較してどちらが安いか検証した"
---
...
本章では、実際のGA4エクスポートデータを使ったクエリを例に取りながら、2つの料金モデルの仕組みと向き不向きを整理します。「エンジニアではないけれど、コストの判断材料が欲しい」という方にも読んでいただけるよう、できる限り平易に解説しています。
