---
title: "【第4部 高速化】BigQueryのマテリアライズドビューでGA4集計クエリを高速化した"
---
...
本章では、BigQueryの**マテリアライズドビュー（Materialized View）**という機能を使って、GA4の集計クエリを高速化した実例をご紹介します。エンジニアでなくても概念が理解できるよう、設定の背景と手順を丁寧に解説します。
