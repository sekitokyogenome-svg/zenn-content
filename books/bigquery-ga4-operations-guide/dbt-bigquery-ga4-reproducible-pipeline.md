---
title: "【第3部 自動化とパイプライン】dbt × BigQueryで再現可能なデータパイプラインを構築する入門【GA4データ編】"
---
...
本章では、**dbt（data build tool）** と **BigQuery** を組み合わせることで、GA4データの変換ロジックをコードとして管理し、再現性の高いデータパイプラインを構築する方法を紹介します。dbtはエンジニアでなくても比較的取り組みやすいツールです。Gitの基本操作とSQLの読み書きができれば、本章の内容を実践していただけます。
...
本章では、dbt × BigQueryを使ってGA4データを扱う再現可能なデータパイプラインを構築する基本的な手順を紹介しました。要点を整理します。
