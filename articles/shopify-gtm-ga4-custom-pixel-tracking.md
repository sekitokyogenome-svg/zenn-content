...
関連記事: [Shopify×GTM×GA4でカスタムピクセルを使った高精度eコマース計測を実装する](https://logical-web.jp/blog/shopify-gtm-ga4-custom-pixel-ecommerce-tracking/?utm_source=zenn&utm_medium=article&utm_campaign=related_article)
