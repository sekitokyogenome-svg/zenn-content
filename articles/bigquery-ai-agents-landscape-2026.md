...
料金の詳細は公式の料金ページに譲りますが、方向性だけ先に共有します。
...
| フェーズ | 内容 | 回数 |
|---|---|---|
| 1 | 全体像と準備（IAM・接続・Knowledge Catalog・世代の違い） | 4 |
...
次回は、実際に AI 機能を使うための IAM と Vertex AI 接続のセットアップを扱います。権限まわりでつまずくポイントが集中している工程なので、丁寧に潰していきます。
