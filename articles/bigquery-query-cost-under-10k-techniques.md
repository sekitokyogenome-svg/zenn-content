...
:::message
クエリ実行前に右上に表示される「処理されるデータ量」の見積もりを事前に確認しましょう。実行前の段階でおおよそのコストを把握できます。
:::
...
関連記事: [BigQueryのクエリコストを月1万円以下に抑える7つの実践テクニック](https://logical-web.jp/blog/bigquery-cost-under-10000-yen-tips/?utm_source=zenn&utm_medium=article&utm_campaign=related_article)
