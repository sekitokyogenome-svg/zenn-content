...
関連記事: [BigQueryでGoogle広告×GA4データを結合してキーワード別の「真のROAS」を計算する](https://logical-web.jp/blog/bigquery-google-ads-ga4-keyword-true-roas/?utm_source=zenn&utm_medium=article&utm_campaign=related_article)
