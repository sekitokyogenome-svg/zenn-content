...
関連記事: [BigQueryから直接Geminiを呼び出してテキストを分析する（AI.GENERATE）](https://logical-web.jp/blog/bigquery-ai-generate-gemini-text-analysis/?utm_source=zenn&utm_medium=article&utm_campaign=related_article)
